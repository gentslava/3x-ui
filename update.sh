    ...
    if [[ $release == "alpine" ]]; then
        ...
        if [ -f "x-ui.service" ]; then
            ...
            if [ "$service_installed" = false ]; then
                ...
                case "${release}" in
                    ubuntu | debian | armbian)
                        ${curl_bin} -fLRo ${xui_service}/x-ui.service https://raw.githubusercontent.com/gentslava/3x-ui/main/x-ui.service.debian > /dev/null 2>&1
                        ;;
                    arch | manjaro | parch)
                        ${curl_bin} -fLRo ${xui_service}/x-ui.service https://raw.githubusercontent.com/gentslava/3x-ui/main/x-ui.service.arch > /dev/null 2>&1
                        ;;
                    *)
                        ${curl_bin} -fLRo ${xui_service}/x-ui.service https://raw.githubusercontent.com/gentslava/3x-ui/main/x-ui.service.rhel > /dev/null 2>&1
                        ;;
                esac
