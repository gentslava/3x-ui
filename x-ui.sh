...
update_menu() {
    ...
    wget -O /usr/bin/x-ui https://raw.githubusercontent.com/gentslava/3x-ui/main/x-ui.sh
...
update_shell() {
    wget -O /usr/bin/x-ui -N https://github.com/gentslava/3x-ui/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
