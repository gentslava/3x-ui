...
<p align="center">
  <a href="https://github.com/gentslava/3x-ui/releases"><img src="https://img.shields.io/github/v/release/gentslava/3x-ui" alt="Release"></a>
  <a href="https://github.com/gentslava/3x-ui/actions"><img src="https://img.shields.io/github/actions/workflow/status/gentslava/3x-ui/release.yml.svg" alt="Build"></a>
  <a href="#"><img src="https://img.shields.io/github/go-mod/go-version/gentslava/3x-ui.svg" alt="GO Version"></a>
  <a href="https://github.com/gentslava/3x-ui/releases/latest"><img src="https://img.shields.io/github/downloads/gentslava/3x-ui/total.svg" alt="Downloads"></a>
  <a href="https://www.gnu.org/licenses/gpl-3.0.en.html"><img src="https://img.shields.io/badge/license-GPL%20V3-blue.svg?longCache=true" alt="License"></a>
  <a href="https://pkg.go.dev/github.com/gentslava/3x-ui/v3"><img src="https://pkg.go.dev/badge/github.com/gentslava/3x-ui/v3.svg" alt="Go Reference"></a>
  <a href="https://goreportcard.com/report/github.com/gentslava/3x-ui/v3"><img src="https://goreportcard.com/badge/github.com/gentslava/3x-ui/v3" alt="Go Report Card"></a>
</p>
...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/gentslava/3x-ui/master/install.sh) v3.4.0
```
...
```bash
bash <(curl -Ls https://raw.githubusercontent.com/gentslava/3x-ui/master/install.sh) dev-latest
```
...
Para la documentación completa, visita la [Wiki del proyecto](https://github.com/gentslava/3x-ui/wiki).
...
```bash
docker run -d --cap-add=NET_ADMIN --cap-add=NET_RAW ... ghcr.io/gentslava/3x-ui
```
...
<a href="https://www.buymeacoffee.com/gentslava" target="_blank">
